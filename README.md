...
**nimhttpd** **[** **-p:**_port_ **-t:**_title_ **-a:**_address_ **-6:**_ipv6_ **-L:** _sizelimit_ **-H:**_"key: val"_ **]** **[** _directory_ **]**
...
- _sizelimit_ is a numerical file size limit for downloads (default: 1GB)
- _-H_ specifies a custom header (like in curl)
